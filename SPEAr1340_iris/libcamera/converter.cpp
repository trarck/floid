...
void
    yuy2_to_yuv420p(unsigned char *bufsrc, unsigned char *bufdest, int width, int height)
{
    ...
    ptrdestcb2 = bufdest + width*height + width/2;

    ptrdestcr1 = bufdest + width*height + width*height/4;
    ptrdestcr2 = bufdest + width*height + width*height/4 + width/2;

    destystride  = (width)*3;
    destccstride = width/2;
...
void
    yuy2_to_yuv420sp(unsigned char *bufsrc, unsigned char *bufdest, int width, int height)
{
    unsigned char *ptrsrcy1, *ptrsrcy2;
    unsigned char *ptrsrcy3, *ptrsrcy4;
    unsigned char *ptrsrccb1, *ptrsrccb2;
